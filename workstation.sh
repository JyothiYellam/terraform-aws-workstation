...
cd /home/ec2-user
sudo -u ec2-user git clone https://github.com/JyothiYellam/eksctl.git
cd eksctl
...
sudo -u ec2-user kubectl config use-context arn:aws:eks:us-east-1:640083577458:cluster/roboshop
